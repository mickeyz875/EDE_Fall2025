...
> Answer: We use drop_na() instead of na.omit() because drop_na() is designed to work seamlessly within a dplyr pipe, while the base R na.omit() can sometimes cause unexpected issues with later group_by() and summarise() steps.
