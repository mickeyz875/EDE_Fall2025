...
```{r boxplot.2018, echo=FALSE, fig.height=3, fig.cap = "2018 monthly Ozone levels"}
ggplot(drop_na(subset(epa_data, Year == 2018)),
       aes(y = Ozone, x = factor(month.abb[Month],levels = month.abb)))+
  geom_boxplot()+
...
```{r boxplot.2019, echo=FALSE, fig.cap = "2019 monthly Ozone levels", fig.height=3}
ggplot(drop_na(subset(epa_data, Year == 2019)),
       aes(y = Ozone, x = factor(month.abb[Month],levels = month.abb)))+
  geom_boxplot()+
...
<https://github.com/mickeyz875/EDE_Fall2025>
